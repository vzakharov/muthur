...
finish=100000
nearly_done() { echo "First judge whether the work is nearly done: whether, by your own estimate, finishing it takes under ~$(k "$finish") more tokens of context$1. If it does, finish it, and say in your report that you did and why rather than stopping."; }
