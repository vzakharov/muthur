...
**An elephant pauses at every chunk end, and the record is the plan's own sections** — ticked steps and a rewritten `## Next chunk`, never a log beside them (`@.claude/skills/plan/elephant.md`). Two ways to get there:
