...
| `docs/adopting/` | `ADOPTING.md`'s chapters — the ones only some adopters read — and the screenshot locating the environment setup script. Goes when that file does, or it is left an orphan. | — | — | never |
